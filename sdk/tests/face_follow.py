...
DEFAULT_PAN_GAIN_DEG_PER_NORM = 4.8
DEFAULT_TILT_GAIN_DEG_PER_NORM = 6.0
DEFAULT_PAN_DEAD_ZONE_NORM = 0.02
DEFAULT_TILT_DEAD_ZONE_NORM = 0.025
DEFAULT_PAN_RESUME_ZONE_NORM = 0.03
DEFAULT_TILT_RESUME_ZONE_NORM = 0.035
DEFAULT_MIN_PAN_STEP_DEG = 0.35
DEFAULT_MIN_TILT_STEP_DEG = 0.7
DEFAULT_PAN_MIN_STEP_ZONE_NORM = 0.08
DEFAULT_TILT_MIN_STEP_ZONE_NORM = 0.12
DEFAULT_MAX_PAN_STEP_DEG = 1.6
DEFAULT_MAX_TILT_STEP_DEG = 1.8
...
DEFAULT_STICTION_EPS_DEG = 0.18
DEFAULT_STICTION_FRAMES = 3
DEFAULT_PAN_BREAKAWAY_STEP_DEG = 1.2
DEFAULT_PAN_BREAKAWAY_STEP_NEG_DEG = 2.0
DEFAULT_PAN_NEGATIVE_SCALE = 1.45
DEFAULT_TILT_BREAKAWAY_STEP_DEG = 1.4
